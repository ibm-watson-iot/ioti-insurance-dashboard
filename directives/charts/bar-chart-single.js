...
function barChartSingleDirective(){
	return {
	    restrict: 'E', // C: class, E: element, M: comments, A: attributes
	    replace: true, // replaces original content with template
	    templateUrl: "directives/charts/bar-chart-single.html",
	    controller: barChartSingleController,
		scope: {
			datasource : "=",
			headers : "=",
			maxwidth : "="
...
function barChartSingleController($scope, $http){
}
...
// directives
app.directive('barChartSingle', [barChartSingleDirective]);
