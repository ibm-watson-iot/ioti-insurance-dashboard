...
function loginFormController($scope, $http, $cookies){
	...
	if ( auth != "") {
	 ...
	 $scope.doLogin = function( ) {
		 ...
		 console.log( "_csrf: " + $scope.csrfToken);
...
// module
var app = angular.module('iot-dashboard-login', ['ngCookies', 'pascalprecht.translate']);
...
// directives
app.directive('loginForm', [loginFormDirective]);
